...
A benchmark problem was considered and consisted in solving the Laplace equation $\Delta u = 0$ in a sphere of unit radius $a=1$ submitted to constant value at its surface $u(r,\theta,\phi) = F(\theta,\phi)$ and under steady-state condition (Figure X). %TODO
